...
public class EditFlavorController {
    ...
    @FXML
    protected JFXComboBox<String> flavStatusCombo;

    @FXML
    protected JFXTextField addFlavorTxt;
        ...
        else if (event.getSource() == saveBtn)
        {
            if(addFlavorTxt.getText() != null && flavStatusCombo.getValue() != null)
            {
...

                {
                    ...
                    alert.setTitle("");
                    alert.setContentText("You have successfully edited a flavor");
                    alert.showAndWait();}
            }
            else
            {
